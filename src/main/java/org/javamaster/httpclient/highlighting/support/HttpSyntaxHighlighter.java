...
public class HttpSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    static {
        ...
        fillMap(ATTRIBUTE_MAP, HTTP_KEYWORD, HttpTypes.REQUEST_METHOD, HttpTypes.IMPORT, HttpTypes.RUN);
        ...
        fillMap(ATTRIBUTE_MAP, HTTP_FILE_PATH, HttpTypes.FILE_PATH_PART, HttpTypes.DIRECTION_VALUE_PART);
